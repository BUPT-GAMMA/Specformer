...
class SpecLayer(nn.Module):
    ...
    def __init__(self, nbases, ncombines, prop_dropout=0.0):
        ...
        self.bn = nn.BatchNorm1d(ncombines)
...
class Specformer(nn.Module):
    ...
    def __init__(self, nclass, nfeat, nlayer, hidden_dim=128, nheads=4, tran_dropout=0.0, feat_dropout=0.0, prop_dropout=0.0):
        ...
        self.feat_encoder = nn.Linear(self.nfeat, hidden_dim)
        ...
        self.layers = nn.ModuleList([SpecLayer(nheads+1, hidden_dim, prop_dropout) for i in range(nlayer)])
